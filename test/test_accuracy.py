...
def test_attention_configs(causal, nhead_q, nhead_k, softmax_scale, dtype, q_block_size, k_block_size, k_q_same_seqlen, headdim,tile_mode):
    ...
    out = HBSAttention(q, k, v, cu_q_seqlens, cu_k_seqlens, block_mask, q_block_size, k_block_size, causal, softmax_scale, tile_mode)
...
# As this post shows, usually the absoluate error is around 0.001, https://x.com/tri_dao/status/1787767984360153283 
...
if __name__ == "__main__":
    test_attention_configs(causal=True, nhead_q=2, nhead_k=2, softmax_scale=None, dtype=torch.bfloat16, q_block_size=16, k_block_size=16, k_q_same_seqlen=False, headdim = 64, tile_mode="scheduling")