...
if __name__ == "__main__":
    ...
    v = torch.arange(k_seqlen,device=device, dtype=dtype).view(k_seqlen, 1, 1).repeat(1, nhead_k, headdim) # torch.randn(k_seqlen, nhead_k, headdim, device=device, dtype=dtype)
